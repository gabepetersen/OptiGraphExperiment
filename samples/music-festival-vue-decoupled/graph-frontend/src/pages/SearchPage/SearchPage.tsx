...
function SearchPage() {
    ...
    const { data: searchQueryData } = useArtistSearchQuery(variables, { staleTime: 2000, enabled: !modeEdit || !!token });
    ...
    const { data: otherContentSearchQueryData } = useOtherContentSearchQuery(variables, { staleTime: 2000, enabled: !modeEdit || !!token });
